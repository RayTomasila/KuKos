      ...
      <tbody>
        <?php foreach ($kontrak as $key => $value): ?>
          <tr>
            ...
            <td>
              <?php
                $tanggal_mulai = DateTime::createFromFormat('Y-m-d', $value['tanggal_mulai']);
                $tanggal_selesai = DateTime::createFromFormat('Y-m-d', $value['tanggal_selesai']);
            ...
            <td class="table-buttons">
              <a href="<?php echo base_url('kontrak/ubah/' . $value['id_kontrak']) ?>">
                <img src="<?php echo base_url('../public/assets/member/kontrak/ubah1.png'); ?>" alt="foto ubah kontrak">
              </a>
              <a href="#" class="btn-hapus" 
                data-href="<?php echo site_url("kontrak/hapus/" . $value['id_kontrak']); ?>">
                <img src="<?php echo base_url('../public/assets/member/kontrak/hapus.png'); ?>" alt="Hapus Kontrak">
              </a>
            </td>
  ...
  <!-- Charts -->
    <section class="container " style="margin-top: 2%;">
        ...
        <div class="container-pemasukan">
          ...
          <p class="laporan-text-mid">Rekap Pembayaran Lunas 6 Bulan Terakhir</p>
            ...
            <script>
              ...
              var months = [];
              var bulanIndo = ['Januari', 'Februari', 'Maret', 'April', 'Mei', 
